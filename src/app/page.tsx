  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-900">
      <aside className="fixed left-0 top-0 hidden h-screen w-64 bg-slate-950 text-white lg:block">
        <div className="flex h-20 items-center border-b border-slate-800 px-6"><div className="mr-3 flex h-11 w-11 items-center justify-center rounded-xl bg-blue-600 text-xl">🏥</div><div><h1 className="font-bold">Rehab Centre</h1><p className="text-xs text-slate-400">Management System</p></div></div>
      ...
      <section className="lg:ml-64">
        ...
        <div className="p-6 sm:p-8">
          ...
          <footer className="mt-10 pb-4 text-center text-xs text-slate-400">Rehab Centre Management System • Version 1.0</footer>
        </div>
      </section>
    </main>
  );
